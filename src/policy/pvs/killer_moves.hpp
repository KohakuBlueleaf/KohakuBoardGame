...
static Move killer_table[MAX_PLY][MAX_KILLER_SLOTS];

static void store_killer(int ply, const Move& move, int slots){
...
static bool is_killer(int ply, const Move& move, int slots){
