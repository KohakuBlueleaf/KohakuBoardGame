...
// Piece-Square Tables (white perspective: row 0 = rank 6 = back rank for opponent)
// Board is 6 rows x 6 columns
static const int pst[6][BOARD_H][BOARD_W] = {
    // Pawn (index 0, piece_id 1)
    {{ 0,  0,  0,  0,  0,  0}, {15, 15, 15, 15, 15, 15},
     { 6,  8, 10, 10,  8,  6}, { 2,  4,  6,  6,  4,  2},
    ...
    {{-4, -2,  0,  0, -2, -4}, {-2,  4,  6,  6,  4, -2},
     { 0,  4,  8,  8,  4,  0}, { 0,  4,  8,  8,  4,  0},
     {-2,  4,  6,  6,  4, -2}, {-4, -2,  0,  0, -2, -4}},
    // Bishop (index 3, piece_id 4)
    {{-2,  0,  0,  0,  0, -2}, { 0,  4,  5,  5,  4,  0},
     { 0,  5,  6,  6,  5,  0}, { 0,  5,  6,  6,  5,  0},
     { 0,  4,  5,  5,  4,  0}, {-2,  0,  0,  0,  0, -2}},
    // Queen (index 4, piece_id 5)
    {{-2,  0,  2,  2,  0, -2}, { 0,  4,  6,  6,  4,  0},
     { 0,  4,  6,  6,  4,  0}, { 0,  4,  6,  6,  4,  0},
     { 0,  2,  4,  4,  2,  0}, {-2,  0,  2,  2,  0, -2}},
    // King (index 5, piece_id 6)
    {{-8, -8, -8, -8, -8, -8}, {-4, -4, -4, -4, -4, -4},
     {-4, -4, -4, -4, -4, -4}, {-4, -4, -4, -4, -4, -4},
     { 4,  4,  0,  0,  4,  4}, { 6,  6,  2,  2,  6,  6}},
};
