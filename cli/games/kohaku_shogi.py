"""Kohaku Shogi game module for CLI -- board display, human input, game logic."""
...
COL_LABELS = "abcdef"
ROW_LABELS = "7654321"  # row_labels[internal_row] = display rank
...
def uci_to_move(uci_str):
    ...
    Formats:
        ...
        'a1b2+'  -> ((from_r, from_c), (to_r + 7, to_c))    promotion
        'P*c3'   -> ((7, piece_type), (to_r, to_c))          drop
    """
...
def move_to_uci(move):
    ...
    Promotion move:   ((fr,fc),(tr+7,tc))           -> 'a1b2+'
    Drop move:        ((7, piece_type),(tr,tc))     -> 'P*c3'
    """
    (fr, fc), (tr, tc) = move
...
def print_board(state, game_ctx):
    """Print Kohaku Shogi board with piece abbreviations and hand pieces."""
    print()
...
def get_human_move(state, game_ctx):
    """Prompt human player for a Kohaku Shogi move via numbered list or algebraic notation."""
