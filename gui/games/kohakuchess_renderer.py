"""Kohaku Chess board renderer -- chess pieces with Unicode glyphs."""
...
class KohakuChessRenderer:
    """Renders Kohaku Chess board with pre-rendered Unicode chess piece glyphs."""
